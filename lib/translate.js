...
For each idiom, set "bucket" to one of "common", "intermediate", or "advanced" reflecting how likely an intermediate Italian learner is to already know the phrase. Use all three buckets generously — aim for roughly 40% common, 30% intermediate, 30% advanced across a session. Guidelines:
- "common": basic football vocabulary any fan would know (e.g. "di testa", "fuorigioco", "palla persa")
- "intermediate": football-specific phrases a motivated learner would recognize (e.g. "uomo in più", "palla scomoda", "verticalizzazione")
- "advanced": idiomatic expressions, metaphors, regional/colloquial phrasing, creative commentary language (e.g. "imbucare il pallone", "girare l'inerzia", "dormita della difesa", "pizzicare dietro le spalle"). Most figurative or metaphorical commentary expressions should be "advanced".
...
- "idioms": [{expression, meaning, bucket}] — bucket is "common" (basic football vocab), "intermediate" (football-specific phrases), or "advanced" (idiomatic, metaphorical, or regional expressions). Aim for ~30% advanced.
...
5. "idioms" — [{expression, meaning, bucket}] for genuine Italian football expressions; bucket is "common" (basic football vocab), "intermediate" (football-specific phrases), or "advanced" (idiomatic, metaphorical, or regional expressions). Aim for ~30% advanced.

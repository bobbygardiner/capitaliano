...
3. "entities": array of named entities [{text, type}] where type is "player"|"team"|"stadium"|"coach" and text is the CORRECT spelling of the name (use match context to fix transcription errors, e.g. "Turam" should become "Thuram" if Thuram is in the squad list)
...
IMPORTANT: The Italian text comes from speech recognition which often misspells player names. Use the match context (if provided) to correct names to their proper spelling in both segments and entities.
